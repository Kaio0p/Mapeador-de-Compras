...
/* ══════════════════════════════════════════════════════════
   3. OVERRIDES MODO ESCURO — @media (prefers-color-scheme)
   Estas regras vêm DEPOIS dos estilos base para sobrescrevê-los
   ══════════════════════════════════════════════════════════ */

@media (prefers-color-scheme: dark) {
    .stApp { background: #1C1C1E !important; }
    [data-testid="stSidebar"] { background: rgba(28,28,30,0.92) !important; border-right: 1px solid rgba(255,255,255,0.07) !important; }
    h1, h2 { color: #F5F5F7 !important; }
    ...
    .stButton > button { background: rgba(44,44,46,0.9) !important; color: #0A84FF !important; border: 1px solid rgba(10,132,255,0.3) !important; }
    .stButton > button:hover { background: rgba(10,132,255,0.12) !important; border-color: rgba(10,132,255,0.6) !important; }
    .stButton > button[kind="primary"], button[data-testid="baseButton-primary"] {
        background: linear-gradient(180deg, #0A84FF 0%, #0071E3 100%) !important; color: #fff !important; border: none !important;
    }
    .stDownloadButton > button { background: linear-gradient(180deg, #30D158 0%, #25A244 100%) !important; }

    [data-testid="stFileUploader"] { background: rgba(44,44,46,0.6) !important; border: 1.5px dashed rgba(10,132,255,0.3) !important; }
    [data-testid="stFileUploader"]:hover { border-color: rgba(10,132,255,0.6) !important; background: rgba(10,132,255,0.06) !important; }
    [data-testid="stFileUploaderDropzoneInstructions"] { color: #8E8E93 !important; }

    div[data-testid="stAlert"] { background: rgba(10,132,255,0.1) !important; border-left: 3px solid #0A84FF !important; }

    .streamlit-expanderHeader { background: rgba(44,44,46,0.75) !important; border: 1px solid rgba(255,255,255,0.07) !important; color: #E5E5EA !important; }
    .streamlit-expanderHeader:hover { background: rgba(58,58,60,0.95) !important; }
    .streamlit-expanderContent { background: rgba(44,44,46,0.5) !important; border: 1px solid rgba(255,255,255,0.06) !important; }

    .stRadio label { background: rgba(44,44,46,0.8) !important; border: 1px solid rgba(255,255,255,0.1) !important; color: #E5E5EA !important; }
    [data-baseweb="select"] > div { background: rgba(44,44,46,0.85) !important; border-color: rgba(255,255,255,0.1) !important; }
    [data-testid="stDataFrame"], iframe { border: 1px solid rgba(255,255,255,0.07) !important; }

    .glass-card { background: rgba(44,44,46,0.75) !important; border: 1px solid rgba(255,255,255,0.08) !important; box-shadow: 0 4px 24px rgba(0,0,0,0.3) !important; }
    .glass-card .supplier-label { color: #636366 !important; }
    .glass-card .supplier-name  { color: #F5F5F7 !important; }
    .step-track { background: rgba(44,44,46,0.75) !important; border: 1px solid rgba(255,255,255,0.07) !important; }
    ...
    .suspect-card { background: rgba(255,149,0,0.05) !important; border-color: rgba(255,149,0,0.2) !important; }
    .suspect-card .suspect-title  { color: #FF9F0A !important; }
    .suspect-card .suspect-reason { color: #FFCC80 !important; }
}

/* ══════════════════════════════════════════════════════════
   4. OVERRIDES MODO ESCURO — [data-theme="dark"]
   Streamlit coloca data-theme no elemento raiz .stApp
   ══════════════════════════════════════════════════════════ */
